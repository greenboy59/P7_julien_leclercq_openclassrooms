  ...
  <div class="card">
    ...
    <form>
      <div class="form-row">
        ...
        <input @input="checkForm()" name="email" v-model="email" class="form-row__input" type="email"
          placeholder="Adresse mail" />
      </div>
      <div class="form-row">
        <label hidden for="password">mot de passe</label>
        <input @input="checkForm()" name="password" v-model="password" class="form-row__input" type="password"
