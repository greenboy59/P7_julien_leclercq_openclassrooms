  ...
  <div v-if="posts.length > 0" id="posts-container">
    ...
    <div :key="post._id" v-for="post in filteredPosts" class="card">
        ...
        <div class="post-subtitle">
          ...
          <span class="total-likes-dislikes">
            <i class="fa-regular fa-thumbs-up">
              &nbsp;<span>{{ post.usersWhoLiked.length }}</span>
            </i>
            <i class="fa-regular fa-thumbs-down">
              &nbsp;<span>{{ post.usersWhoDisliked.length }}</span>
            </i>
          </span>
        </div>
      </div>
      ...
      <div class="posts-options">
        ...
        <div v-if="user.userId === post.userId || isAdmin" class="modify-delete-buttons">
          <button class="button modify-button" @click="modifyPost(post._id)">
            <i class="fas fa-edit modify"></i>
            <b>Modifier</b>
          </button>

          <button class="button delete-button" @click="showModalDeletePost(post._id)">
          ...
          <ModalWindow v-show="showModal" @close="showModal = false">
            ...
            <template #actions>
              <div class="modal-actions-buttons">
                <button class="button modal-button-validate" @click="deletePost(post._id)">
                  Valider
                </button>
